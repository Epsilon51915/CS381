...
// ===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===
//          Game Idea: Horror Penguins
//      4 penguins (or a smaller but ever increasing number,) all start turned around but slowly turn to look at the player.
//      If a penguin ever fully looks at the player, the penguin attacks the player and they lose. To deter the penguins, the player can
//      press A or D to turn the penguins in the other direction, but each turn this way increases the penguin's turning speed. The player
//      cannot ever win, only stall their inevitable salmony demise
// ===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===*===
